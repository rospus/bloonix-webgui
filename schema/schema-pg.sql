...
CREATE TABLE "company" (
    ...
    "max_charts"                 BIGINT NOT NULL DEFAULT 10000,
    "max_metrics_per_chart"      SMALLINT NOT NULL DEFAULT 100,
    "max_dashboards_per_user"    SMALLINT NOT NULL DEFAULT 100,
    "max_dashlets_per_dashboard" SMALLINT NOT NULL DEFAULT 100,
...
CREATE SEQUENCE "roster_id_seq" START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
...
CREATE SEQUENCE "roster_contact_id_seq" START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
