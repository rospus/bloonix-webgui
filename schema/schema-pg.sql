...
CREATE TABLE "company" (
    ...
    "max_contactgroups" INTEGER NOT NULL DEFAULT 0,
    "max_groups"        INTEGER NOT NULL DEFAULT 0,
    "max_timeperiods"   INTEGER NOT NULL DEFAULT 0,
    "max_timeslices"    INTEGER NOT NULL DEFAULT 0,
    "max_groups"        INTEGER NOT NULL DEFAULT 0,
    "max_users"         INTEGER NOT NULL DEFAULT 0,
    "max_sms"           BIGINT NOT NULL DEFAULT '0',
