...
var Lang = {
   "en" : {
      ...
      "schema.service.desc.attempt_warn2crit" : "This option is useful if you want that the status of the service upgrades to CRITICAL if the real status is WARNING and max attempts were reached.",
